...
const Certifications: React.FC = () => {
  ...
  const filters = ['All','Programming','Design','Cloud Computing','Data Analysis','Artificial Intelligence','Networking','Version Control','Information Technology','Software Tools'];
